                    ...
                    <form method="POST" action="{{ route('articles.update', $article->id) }}">
                        ...
                        <div id="english-form">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="en_title" type="text" class="form-control @error('en_title') is-invalid @enderror" name="en_title" value="{{ old('en_title', optional($article->translate('en'))->title) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea name="en_full_text" id="en_full_text" class="form-control @error('en_full_text') is-invalid @enderror" rows="8">{{ old('en_full_text', optional($article->translate('en'))->full_text) }}</textarea>
                        ...
                        <div class="d-none" id="lithuanian-form">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="lt_title" type="text" class="form-control @error('lt_title') is-invalid @enderror" name="lt_title" value="{{ old('lt_title', optional($article->translate('lt'))->title) }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea name="lt_full_text" id="lt_full_text" class="form-control @error('lt_full_text') is-invalid @enderror" rows="8">{{ old('lt_full_text', optional($article->translate('lt'))->full_text) }}</textarea>
